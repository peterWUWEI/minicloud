    ...
    <v-app>
        <v-container fill-height fluid>
            <v-row justify="center">
                <material-card color="green" title="新闻" text="创建新的新闻内容">
                    <v-form v-model="isFormValid" @submit.prevent="addNews">
                        <v-container class="py-0">
                            <v-row>
                                ...
                                <v-col cols="12" class="editor">
                                    ...
                                    <v-divider />
                                    <editor v-model="news_content"></editor>
                                </v-col>
...
export default {
    ...
    data() {
        return {
            news_content: 'Please type in here',
            isFormValid: false,
    ...
    methods: {
        async addNews() {
            const res = await this.$axios.post(`/news/create`, {
